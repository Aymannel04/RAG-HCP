...
PROMPT_SYSTEME_REFORMULATION = (
    ...
    "chiffre', 'cette periode') qui ne se comprend qu'avec l'historique : remplace "
    "UNIQUEMENT ce mot ou cette reference par ce qu'il designe reellement dans "
    "l'historique, sans rien ajouter d'autre.\n"
    "Cas 1bis -- la question est une suite elliptique ('et pour...', 'et en...', 'et "
    "les hommes ?') qui omet le sujet/la mesure de la question precedente : reconstruis "
    "la question complete en reprenant EXACTEMENT le sujet de la question precedente, "
    "seule la partie apres 'et pour'/'et en' change. Exemple -- historique 'Q: Quel est "
    "le taux de chomage ? R: 13%...', question de suivi 'Et pour les femmes ?' -> "
    "reformule en 'Quel est le taux de chomage pour les femmes ?' (le sujet manquant, "
    "'le taux de chomage', vient de la question precedente).\n"
    ...
    "Cas 1/1bis. Ne comble jamais un manque de clarte d'ECRITURE en piochant un sujet "
    "dans l'historique : seule la presence d'un mot de reference explicite ('ça', 'ce "
    "chiffre', 'cette periode'...) ou d'une suite elliptique ('et pour...', 'et "
    "en...') justifie d'aller chercher dans l'historique. Si tu "
